...
- **이번 프로젝트에서 맡은 역할**
  - 피그마를 이용한 UI 설계
  - Naver Maps API를 사용한 지도 UI, 도로명 검색 구현
  - Naver Search API를 활용한 지도 장소명 검색 구현
  - AWS S3 이미지 업로드 환경 설정
  - 관리자 신고 및 규제 처리 기능 구현
  - ui Store 


- **잘한 점**
  - 초기 기획 의도에 맞게 사용자 경험 중심의 UI 구현
  - 정해둔 API 명세 방식을 따라 일관된 응답 구조 및 로그 처리를 가능하게 함

- **아쉬운 점**
  - Axios 에러 핸들링에서 예외 케이스를 더 고려했으면 좋았을 것
  - PR 을 자세하게 확인하
  - 
...
- **다음 프로젝트에 적용하고 싶은 점**
  - 코드 리뷰를 주기적으로 진행하기
  - 작업 분담 시 담당 도메인과 기한을 확실하게 
  - 서비스 기획서를 더 성세하고 명확하게 작성하고 개발을 시작하기
